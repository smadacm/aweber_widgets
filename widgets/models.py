...
class Widget(models.Model):
    ...
    """
    name = models.CharField('Name', max_length=NAME_MAX_LENGTH, null=False,
                            blank=False)
    parts_count = models.IntegerField('Number of parts', default=0, null=False,
                                      blank=False)
